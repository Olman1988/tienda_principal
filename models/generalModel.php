...
class generalModel{
    ...
    try {
           ...
           $consulta =$db->prepare("SELECT eo.descripcion as estado, o.codigo,o.Total,o.idPaymentType,o.fecha as creationdate,o.TotalTax,o.Shipping,o.SubTotal,o.userName,u.nombre AS cliente,u.apellido,u.telefono,u.email,oe.provincia,oe.canton,oe.distrito,oe.address,oe.shippingMethod FROM Orden o LEFT JOIN usuarios u on o.userName = u.email LEFT JOIN OrdenEntrega oe ON o.id = oe.idOrden LEFT JOIN estadosOrdenes eo ON o.estado = eo.ID where o.userName='$email' order by o.fecha desc");
    ...
    try {
            ...
            $consulta =$db->prepare("SELECT o.estado as idEstado, eo.descripcion as status,o.codigo,o.Total,o.idPaymentType,o.fecha as creationdate,o.TotalTax,o.Shipping,o.SubTotal,o.userName,u.nombre AS cliente,u.apellido,u.telefono,u.email,oe.provincia,oe.canton,oe.distrito,oe.address,oe.shippingMethod FROM Orden o LEFT JOIN usuarios u on o.userName = u.email LEFT JOIN OrdenEntrega oe ON o.id = oe.idOrden LEFT JOIN estadosOrdenes eo ON o.estado =eo.ID order by o.fecha asc");
           //$consulta->bindValue(':id', $idCategoria);
            $consulta->execute();
