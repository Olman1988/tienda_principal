 ...
 <!-- Page Title-->
    ...
    <div class="container pb-3 mb-1 section-category">
        <div class="row content-categories">
          <!-- Products-->
          <div class="col-xl-10 col-lg-9 order-lg-2 mb-4" style=''>
            <!-- Shop Toolbar-->
            <div class="shop-toolbar mb-2">
              
              <div class="column">
                  <div class="float-right shop-view"><a class="grid-view active" href="<?=base_url?>?pag=categorias&&id=<?=$_GET['id']?>&&nombre=<?=$_GET['nombre']?>"><i class="fa-solid fa-grip"></i></a><a class="list-view" href="<?=base_url?>?pag=categoriasLista&&id=<?=$_GET['id']?>&&nombre=<?=$_GET['nombre']?>"><i class="fa-solid fa-list"></i></a></div>
              </div>
            </div>
...
<!--                    <div class="zoom" id="<?=$ext?>">
                        <img src="<?=base_url2.$value['rutaImagen']?>" alt="Producto">
                         ...
                         <div class="main-img" id="" style='max-height:600px;'>
                        <img src="<?=base_url2.$value['rutaImagen']?>" alt="Producto">
                       </div>
                        </a>
