...
<div class="row mx-auto" style=";">
    <div style="height:120px;margin-left:10px;cursor:pointer;" onclick="cambiarImagen('<?=$respuestaArticulo['rutaImagen']?>')" class="active col-3">
    ...
    if(count($respuesFin)>0){
     ...
     ?>
    <div style="height:120px;margin-left:10px;cursor:pointer;" onclick="cambiarImagen('<?=$valueRespuesta['rutaImagen']?>')" class=" col-3">
    ...
    ?>     
         ...
         <div class="col-md-6">
                ...
                <div class="pt-1 mb-2"><span class="text-medium">SKU:</span> #<?=$respuestaArticulo['sku']?></div>
                <div class="row ">
                    <div class="col-sm-3">
