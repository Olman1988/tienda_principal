<?php
	...
	foreach($respuestaSlider as $respuestaSlidervalue){
		if($respuestaSlidervalue['type'] == 1 && $respuestaSlidervalue['Status'] == '1'){
?>
	...
	<?php
		}else if($respuestaSlidervalue['type'] == 2 && $respuestaSlidervalue['Status'] == '1'){
	?>
		<div style="min-height:70vh;">
	...
	<?php
		}else if($respuestaSlidervalue['type'] == 3 && $respuestaSlidervalue['Status'] == '1'){
			$sliderMov = true;
			$contSlider++;
	?>
		<div id="sliderI" class="slider">
			<div class="myslider fdd" style="display:block">
				<a href="<?= $respuestaSlidervalue['url_movimiento'] ?>">
					<div class="image_slider home" style="background-image:url(<?= base_url . $respuestaSlidervalue['sliderPathMovimiento']?>);"></div>
