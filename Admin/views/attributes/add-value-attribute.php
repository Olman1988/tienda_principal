...
<section style="margin:auto;padding:20px;width:80%;min-width:300px;margin-top:50px;">
    <form id="formularioRegistro" action="./?seccion=attributeValues&&action=action-add&&description=<?=isset($_GET['description'])&&!empty($_GET['description'])?$_GET['description']:''?>" method="POST" enctype="multipart/form-data">
      <input type='hidden' name='id' value='<?=$_GET['id']?>'>      
      <div class="row">
                <h2>Agregar Valores para <?=$nombre?></h2>
                <div class="col-6"> 
                ...
                <div class="col-6"> 
                   <div class="form-group">
                        ...
                        <input name="orden" type="number" id="nombre" class="form-control" value='' />
                    </div>
                </div>
                 <div class="col-6">
                            <div class="form-group">
