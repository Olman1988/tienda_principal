      ...
      <div class="row">
                ...
                <div class="col-6"> 
                   <div class="form-group mt-2">
                        ...
                        <input required name="titulo" type="text" id="" value="titulo" class="form-control"/>
                    </div>
                </div>
                 <div class="col-6"> 
                        <input name="id" type="hidden" id="" value="<?=$respConsultaSliders->id?>" class="form-control"  />
                </div>
                <div class="col-6"> 
                   <div class="form-group mt-2">
                        <label for="url">URL</label>
                        <input name="url" type="text" id="" value="<?=$respConsultaSliders->url?>" class="form-control"/>
                    </div>
                </div>
                <div class="col-6"> 
                   <div class="form-group mt-2">
